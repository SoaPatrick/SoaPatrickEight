...
?>
    ...
    <footer class="site-footer highlight">
      <p class="site-footer__copyright">
        <?php echo sprintf( __( 'Stuff from 2000 to %s by SoaPatrick/<a href="%s">Seven</a>', 'soapatrickeight' ), date('Y'), esc_url( home_url( '/log' )) ); ?>
      </p>
      <p class="site-footer__data-protection">
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>data-protection" aria-label="<?php esc_html_e( 'Data Protection', 'soapatrickeight' ); ?>">
          <span><?php esc_html_e( 'Data Protection', 'soapatrickeight' ); ?></span>
