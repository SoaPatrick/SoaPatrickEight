...
<nav class="site-navigation">
  ...
  <a class="site-navigation__link" href="<?php echo esc_url( home_url( '/' ) ); ?>storage" aria-label="<?php esc_html_e( 'Storage', 'soapatrickeight' ); ?>">
  ...
  <a class="site-navigation__link" href="<?php echo esc_url( home_url( '/' ) ); ?>factory" aria-label="<?php esc_html_e( 'Factory', 'soapatrickeight' ); ?>">
  ...
  <button type="button" class="site-navigation__link" aria-label="<?php esc_html_e( 'Settings', 'soapatrickeight' ); ?>" id="toggle-settings">
  ...
  <button type="button" class="site-navigation__link" aria-label="<?php esc_html_e( 'Find Stuff', 'soapatrickeight' ); ?>" id="toggle-search-collapse">
    <span><?php esc_html_e( 'Find Stuff', 'soapatrickeight' ); ?></span>
    <svg aria-hidden="true" focusable="false" class="site-navigation__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
