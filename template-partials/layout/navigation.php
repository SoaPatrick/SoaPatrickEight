...
<nav class="site-navigation">
    ...
    <!-- <a class="site-navigation__link" href="<?php echo esc_url( home_url( '/' ) ); ?>box"><?php esc_html_e( 'Box', 'soapatrickeight' ); ?></a> -->
    <a class="site-navigation__link site-navigation__link--animation" href="<?php echo esc_url( home_url( '/' ) ); ?>storage"><?php esc_html_e( 'Storage', 'soapatrickeight' ); ?></a>
    <a class="site-navigation__link site-navigation__link--animation" href="<?php echo esc_url( home_url( '/' ) ); ?>factory"><?php esc_html_e( 'Factory', 'soapatrickeight' ); ?></a>
    <a class="site-navigation__link site-navigation__link--animation site-navigation__link--patrick" href="<?php echo esc_url( home_url( '/' ) ); ?>patrick"><?php esc_html_e( 'Patrick', 'soapatrickeight' ); ?></a>
    <a class="site-navigation__link site-navigation__link--animation" id="toggle-settings"><?php esc_html_e( 'Settings', 'soapatrickeight' ); ?></a>
    <a class="site-navigation__link site-navigation__link--animation" id="toggle-search-collapse"><?php esc_html_e( 'Search', 'soapatrickeight' ); ?></a>
</nav>
