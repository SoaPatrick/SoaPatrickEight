...
<nav class="site-navigation">
  <a class="navbar-brand" href="<?php echo esc_url( home_url() ); ?>" aria-label="SoaPatrick">
  ...
  <ul class="navbar-nav">
    ...
    <li><a class="navbar-nav__link" id="toggle-search-collapse"><?php esc_html_e( 'Search', 'soapatrickeight' ); ?></a></li>
  </ul>
</nav>
