...
<nav class="site-navigation">
  <ul>
    ...
    <li><a class="site-navigation__link site-navigation__link--animation" href="<?php echo esc_url( home_url( '/' ) ); ?>storage"><?php esc_html_e( 'Storage', 'soapatrickeight' ); ?></a></li>
    <li><a class="site-navigation__link site-navigation__link--animation" href="<?php echo esc_url( home_url( '/' ) ); ?>factory"><?php esc_html_e( 'Factory', 'soapatrickeight' ); ?></a></li>
    <li><a class="site-navigation__link site-navigation__link--animation site-navigation__link--patrick" href="<?php echo esc_url( home_url( '/' ) ); ?>patrick"><?php esc_html_e( 'Patrick', 'soapatrickeight' ); ?></a></li>
    <li><button type="button" class="site-navigation__link site-navigation__link--animation" id="toggle-settings"><?php esc_html_e( 'Settings', 'soapatrickeight' ); ?></button></li>
    <li><button type="button" class="site-navigation__link site-navigation__link--animation" id="toggle-search-collapse"><?php esc_html_e( 'Search', 'soapatrickeight' ); ?></button></li>
  </ul>
</nav>
